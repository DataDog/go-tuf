...
// getTargetFileMeta searches for a verified TargetFileMetas matching a target
...
func (c *Client) getTargetFileMetas(targets []string) (data.TargetFiles, error) {
	...
	for _, target := range targets {
		...
		targetFileMeta, _, err := c.getTargetFileMetaDelegationPath(snapshot, normalizedTarget, cache)
...
func (c *Client) getTargetFileMetaDelegationPath(snapshot *data.Snapshot, target string, cache *delegatedTargetsCache) (data.TargetFileMeta, []string, error) {
